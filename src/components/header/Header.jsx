      ...
      <div className="headerActions">
        <button className="headerNotifBtn" aria-label="Notificaciones">
          <svg className="headerBell" viewBox="0 0 24 24" fill="none">
            <path
              d="M12 2C10.3 2 8.8 2.7 7.7 3.8C6.6 4.9 6 6.4 6 8V14L4 16V17H20V16L18 14V8C18 6.4 17.4 4.9 16.3 3.8C15.2 2.7 13.7 2 12 2Z"
              stroke="#555"
              strokeWidth="1.8"
              strokeLinecap="round"
          ...
          >
            <div className="headerAvatar">
              <svg viewBox="0 0 100 100" fill="none">
                ...
                <path
                  d="M20 85 Q20 65 50 65 Q80 65 80 85 L80 100 L20 100Z"
                  fill="#4A90D9"
                />
                <path d="M46 65 L50 80 L54 65Z" fill="#E8A020" />
                <path
                  d="M44 65 L50 72 L56 65"
                  stroke="white"
                  strokeWidth="2"
                  fill="none"
                />
                ...
                <path
                  d="M32 36 Q32 20 50 20 Q68 20 68 36 Q68 30 50 28 Q32 30 32 36Z"
                  fill="#5C3D1E"
                />
                <path
                  d="M32 36 Q30 42 32 44"
                  stroke="#5C3D1E"
                  strokeWidth="3"
                  fill="none"
                />
                <path
                  d="M68 36 Q70 42 68 44"
                  stroke="#5C3D1E"
                  strokeWidth="3"
                  fill="none"
                />
                ...
                />
                <path
                  d="M49 50 Q47 54 50 55 Q53 54 51 50"
                  fill="#C07850"
                  opacity="0.6"
                />
              </svg>
          ...
          {menuAbierto && (
            <div className="dropdownMenu">
              ...
              <button
                ...
                onClick={() => handleNavegar("/wasteForm")}
              >
